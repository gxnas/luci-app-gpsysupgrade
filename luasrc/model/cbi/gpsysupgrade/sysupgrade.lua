...
local Variable1 = "gxnas"
local Variable2 = "OpenWrt_Build_x64"
local Variable3 = "OpenWrt_2305_x64_test"
local Variable4 = "OpenWrt_2305_x64_test"
...
function to_check()
	...
	if model == "x86_64" then
		...
		if fs.access("/sys/firmware/efi") then
			download_url = "https://github.com/" ..Variable1.. "/" ..Variable2.. "/releases/download/" ..Variable3.. "_" ..Variable4.. "/" ..dateyr.. "-" ..Variable4.. "-efi.img.gz"
		else
			download_url = "https://github.com/" ..Variable1.. "/" ..Variable2.. "/releases/download/" ..Variable3.. "_" ..Variable4.. "/" ..dateyr.. "-" ..Variable4.. "-bios.img.gz"
		end
	else
